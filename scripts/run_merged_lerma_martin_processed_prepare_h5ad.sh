...
INPUT="${1:-/Users/chrislangseth/Downloads/merged_lerma_martin_processed.h5ad}"
OUTPUT_H5AD="${2:-/Users/chrislangseth/Downloads/merged_lerma_martin_processed.companion.ready.h5ad}"

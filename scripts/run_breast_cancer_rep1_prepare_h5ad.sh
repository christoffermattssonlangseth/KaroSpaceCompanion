...
INPUT="${1:-/Users/chrislangseth/work/karolinska_institutet/projects/KaroSpaceDataWrangling/data/processed/xenium-dapi-he/breast_cancer_rep1.h5ad}"
OUTPUT_H5AD="${2:-/Users/chrislangseth/work/karolinska_institutet/projects/KaroSpaceDataWrangling/data/processed/xenium-dapi-he/breast_cancer_rep1.companion.ready.h5ad}"
